...
#     def forward(self, encoded_spconv_tensor, batch_size=1):
#         x = encoded_spconv_tensor
...
#         data_dict = {} #TODO for training output data
#         if self.training:
#             target_dict = self.assign_targets(
#                 data_dict['gt_boxes'], num_voxels, spatial_indices, spatial_shape
#             )
...
#             if self.predict_boxes_when_training:
#                 rois, roi_scores, roi_labels = self.reorder_rois_for_refining(batch_size, pred_dicts)
#                 data_dict['rois'] = rois
#                 data_dict['roi_scores'] = roi_scores
#                 data_dict['roi_labels'] = roi_labels
#                 data_dict['has_class_labels'] = True
...
#         # return pred_dicts, data_dict # for training
#         return pred_dicts # final_box_dicts